        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            @elseif($isSeller)
                <div class="bg-purple-50 border border-purple-200 rounded-lg mb-6 p-4">
                    ...
                    @if($workInstance->order->payment_status !== 'paid')
                        <div class="mt-4 pt-4 border-t border-purple-200">
                            <div class="flex items-center gap-2 text-amber-700">
                                ...
                                <span class="text-sm font-medium">⚠️ Payment Status: <span class="font-bold uppercase">{{ $workInstance->order->payment_status ?? 'pending' }}</span></span>
                            </div>
                            <p class="text-xs text-amber-600 mt-2 ml-7">💡 You can complete your work, but the order won't be marked as complete until the buyer settles payment.</p>
                        </div>
                    @else
                        <div class="mt-4 pt-4 border-t border-purple-200">
                            <div class="flex items-center gap-2 text-green-700">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
                                <span class="text-sm font-medium">✅ Payment Status: <span class="font-bold uppercase">PAID</span></span>
                            </div>
                            <p class="text-xs text-green-600 mt-2 ml-7">💡 Payment is settled. Once you complete all work steps, the order will be automatically marked complete.</p>
                        </div>
                    @endif
                </div>
            @endif
