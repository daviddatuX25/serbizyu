<x-app-layout header="Browse Services">
    <div class="max-w-7xl mx-auto px-6 py-10 space-y-8">
         <!-- Sticky Search + Scrollable Filters -->
    <div class="sticky top-0 bg-gray-50 z-50 p-4 rounded-b-xl shadow-md">
      <!-- Search Bar -->
      <div class="mb-3">
        <input type="text" placeholder="Search services or offers..."
               class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-600 text-sm" />
      </div>
