...
<div class="border-b pb-4 last:border-b-0">
    <div class="flex justify-between items-start mb-2">
        <div class="flex items-center">
            <img src="{{ $review->reviewer->media()->where('tag', 'profile_image')->first()?->getUrl() ?? 'https://ui-avatars.com/api/?name=' . urlencode($review->reviewer->firstname . ' ' . $review->reviewer->lastname) }}"
        ...
        <div class="flex items-center space-x-2">
            ...
            <!-- Flag Review Button -->
            <button type="button"
                    @click="$dispatch('open-flag-modal', { id: {{ $review->id }}, title: 'Review by ' + '{{ $review->reviewer->firstname }} {{ $review->reviewer->lastname }}' })"
