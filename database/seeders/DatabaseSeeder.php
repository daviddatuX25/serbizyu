...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $this->call([
            ...
            // 6.5. Bookmark workflows for users
            WorkflowBookmarkSeeder::class,

            // 7. DISABLED: Services and open offers are now seeded via seeder.json + php artisan seed:from-seeder-json
